    ...
    $.ajax({
        ...
        success: function(res){
            ...
            data.forEach(item => {
                ...
                const now = moment();
                if(now.format('YYYY-MM-DD HH:mm') > item.concert_date+' '+ item.concert_start){
                    const card = `
                        <div class="col-md-4 mb-4">
                            <div class="card h-100 shadow-sm">
                                ...
                                <div class="card-body d-flex flex-column justify-content-between h-100">
                                    ...
                                    <p class="mb-0 text-muted"><i class="fa-solid fa-circle-check me-1 text-danger"></i> Concert Out of Date</p>
                                </div>
                            </div>
                        </div>
                    `;
                ...
                if (response.success) {
                    const now = moment();
                        if(response.data.ticket_redeem == 1){
                            ...
                            if(now.format('YYYY-MM-DD HH:mm') > response.data.concert_date+' '+ response.data.concert_start){
